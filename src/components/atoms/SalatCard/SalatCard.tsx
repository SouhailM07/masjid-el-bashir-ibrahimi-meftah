...
export default function SalatCard({ time, name, img, index }) {
  return (
    <motion.div
      ...
      className="drop-shadow-xl  salat-card aspect-video h-[12rem] max-lg:h-[10rem] overflow-hidden max-md:w-full flex items-end justify-between text-[1.2rem] p-[2rem] rounded-sm text-secondary bg-primary"
      style={{
