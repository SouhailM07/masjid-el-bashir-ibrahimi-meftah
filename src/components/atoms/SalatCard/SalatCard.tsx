...
export default function SalatCard({ time, name, img }) {
  ...
  return (
    <div
      className="drop-shadow-xl hover:scale-105 salat-card aspect-video h-[12rem] flex items-end justify-between text-[1.2rem] p-[2rem] rounded-sm text-secondary bg-primary"
      style={{
